...
bigImg.addEventListener('click', e => {
  ...
  let slideIndex = document.querySelector('.selected').firstElementChild.dataset.slide
...
thumbnailImages.forEach(pic => {
  pic.addEventListener('click', e => {
    bigImg.src = `images/image-product-${e.target.querySelector('img').dataset.slide}.jpg`
    thumbnailImages.forEach(pic => {
      pic.classList.remove('selected')
    })
